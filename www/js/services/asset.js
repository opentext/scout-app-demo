    ...
    function Asset(Expedition, Location, $q, $http, $auth, $rootScope) {
        ...
        function upload(folderId, name, fileUrl) {
            var promise = $q.defer(),
                ...
                url,
                dataUrl,
                auth = new Appworks.Auth(onAuthSuccess, onAuthFail);
            ...
            function onAuthSuccess(data) {
                console.log('Got auth, now uploading image via contentService...', data);
                blob = dataUrlToBlob(dataUrl);
                req = generateUploadReq(name, blob, data.authData);
                url = generateUrl(folderId, data.authData.gatewayUrl);
        ...
        function generateUrl(folderId, gatewayUrl) {
            return gatewayUrl + $rootScope.contentServicePath + folderId + '/children';
        }

        function generateUploadReq(name, file, config) {

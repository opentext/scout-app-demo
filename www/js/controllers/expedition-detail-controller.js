...
function ExpeditionDetailController($scope, $state, $stateParams, $ionicModal, $ionicActionSheet, Expedition, Location, $window, $csDocument, $ionicPopup) {
    ...
    function recordCurrentLocation() {
        var geo = new Appworks.AWLocation(
            function (position) {
